...
from .cache import session_cache, flash_cache, worker_output_cache
...
async def lifespan(app: FastAPI):
    ...
    await worker_output_cache.connect(host=settings.REDIS_HOST, port=settings.REDIS_PORT, db=5)
    ...
    await worker_output_cache.close()